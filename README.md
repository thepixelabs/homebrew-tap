...
| amnesiai | Formula | 0.5.1 | git your ai setup — backup and restore AI coding assistant configurations | `brew install thepixelabs/tap/amnesiai` |
| rover-tui | Formula |  | SSH-friendly TUI session manager and AI agent launcher for your Mac | `brew install thepixelabs/tap/rover-tui` |
