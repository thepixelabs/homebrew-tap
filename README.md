...
|------|------|---------|-------------|---------|
| dispatch | Cask | 1.34.1 | Local-first AI agent monitor for Claude, Codex, Gemini, and Copilot | `brew install --cask thepixelabs/tap/dispatch` |
...
| amnesiai | Formula | 1.2.0 | git your ai setup — backup and restore AI coding assistant configurations | `brew install thepixelabs/tap/amnesiai` |
